...
data_file = "C:\Mini-Customer-personality-analysis\Data\\marketing_campaign.csv"
...
with left:
    ...
    customer_ids = sorted(df["ID"].astype(int).tolist())
...
customer_row = df[df["ID"] == selected_id].iloc[0]
customer_idx = df[df["ID"] == selected_id].index[0]
